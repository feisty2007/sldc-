...
{
    /// <summary>
    /// Summary description for swcsone.
    /// </summary>
    [Guid("e220710e-991b-4005-8a70-ab9cbab19ee7"), ComVisible(true)]
    [SwAddin(
        Description = "swcsone description",
        Title = "swcsone",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public void AddCommandMgr()
        {
            ...
            cmdGroup.LargeIconList = iBmp.CreateFileFromResourceBitmap("swcsone.ToolbarLarge.bmp", thisAssembly);
            cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("swcsone.ToolbarSmall.bmp", thisAssembly);
            cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("swcsone.MainIconLarge.bmp", thisAssembly);
            cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("swcsone.MainIconSmall.bmp", thisAssembly);
